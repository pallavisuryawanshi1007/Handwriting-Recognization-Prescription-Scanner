...
<body>
    ...
    <script>
        ...
        // Fake Progress Bar Animation on Upload
        uploadForm.addEventListener("submit", function(event) {
            ...
            const interval = setInterval(() => {
                ...
                if (progress >= 100) {
                    ...
                    setTimeout(() => {
                        uploadForm.submit(); // Submit after animation completes
                    }, 500);
                }
            }, 300);
        });
...
def upload():
    ...
    if not detected_medicines:
        return jsonify({"message": "No medicines detected"}), 200
    ...
    return jsonify({
        "message": "Medicines detected successfully",
